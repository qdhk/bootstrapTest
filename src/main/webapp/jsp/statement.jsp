	...
	<div class="content">
	    ...
	    <div class="sidebar">
	        ...
	        <ul id="nav">
	          ...
	          <li class="has_sub"><a href="#" class="open"><i class="icon-file-alt"></i> Pages #2  <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
	            <ul>
	    ...
	    <!-- Sidebar ends -->
	      ...
	      <!-- Page heading -->
	      <div class="page-head">
	        <h2 class="pull-left"><i class="icon-file-alt"></i> Statement</h2>
